    ...
    <div className="bg-black min-h-screen flex relative">
      ...
      <div className={`${
        ...
        <nav className="space-y-2">
          ...
          <Link href="/shop" className="flex items-center space-x-4 p-3 text-white transition-all duration-300 cursor-pointer group relative overflow-hidden rounded-lg bg-gray-900">
