    ...
    <div className="bg-black min-h-screen flex relative">
      ...
      <div className={`${
        ...
        <nav className="space-y-6">
          <Link href="/" className="flex items-center text-right justify-between text-lg lg:text-xl space-x-3 p-2 rounded-xl text-gray-300 hover:text-white hover:bg-gray-900">
            <Home size={32} />
            <span>{translations.navigation?.home}</span>
          </Link>
          <div className="flex items-center text-right justify-between text-lg lg:text-xl space-x-3 p-2 rounded-xl text-gray-300 hover:text-white hover:bg-gray-900">
            <User size={32} />
            <span>{translations.navigation?.account}</span>
          </div>
          <Link href="/shop" className="flex items-center text-right justify-between text-lg lg:text-xl space-x-3 p-2 rounded-xl text-white bg-gray-900">
            <ShoppingCart size={32} />
            <span>{translations.navigation?.shop}</span>
          </Link>
        </nav>
      </div>
