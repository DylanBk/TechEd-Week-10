...
import { Home, User, ShoppingCart, Shield, Check } from "lucide-react";
import { Elements } from '@stripe/react-stripe-js';
import { loadStripe } from '@stripe/stripe-js';
import convertToSubCurrency from '@/lib/convertToSubCurrency';
import Checkout from '@/components/Checkout';

// Fix the environment variable name here
...
export default function PolaritePaymentPage() {
  ...
  return (
    <div className="bg-black w-screen h-screen flex overflow-hidden">
      {/* Left Sidebar */}
      <div className="w-1/5 h-screen bg-black p-6 flex flex-col">
        {/* Logo */}
        <div className="mb-12">
        ...
        <nav className="space-y-6">
          ...
          <div className="flex items-center text-right justify-between text-3xl space-x-3 p-2 rounded-xl text-white bg-gray-900">
      ...
      <div className="w-4/5 h-screen bg-black p-8 overflow-hidden">
        <div className="h-full bg-gray-900 rounded-2xl border border-gray-700 flex overflow-hidden">
          
          {/* Left Side - Product Info */}
          <div className="w-2/5 p-8 flex flex-col justify-center overflow-y-auto">
            
            {/* Polar Premium Card - Matching your image */}
          ...
          <div className="w-3/5 p-8 flex flex-col min-h-0">
            ...
            {/* Payment Form Container - Scrollable */}
